...
BezierCurve.prototype.setVisualizeP = function(bShow)
{
	this.VisualizeP = bShow;
}
...
// ################ Edit your code below
	...
	if (this.nodes.length == 3)
	{
		...
		var q0 = Node.lerp(p00, p01, t);
		var q1 = Node.lerp(p01, p02, t);

		var r0 = Node.lerp(q0, q1, t);
	...
	else if (this.nodes.length == 4)
	{
		...
		var q0 = Node.lerp(p00, p01, t);
		var q1 = Node.lerp(p01, p02, t);
		var q2 = Node.lerp(p02, p03, t);

		var r0 = Node.lerp(q0, q1, t);
		var r1 = Node.lerp(q1, q2, t);

		var t0 = Node.lerp(r0, r1, t);
...
BezierCurve.prototype.adapativeDeCasteljauDraw = function()
{
	...
	if(flat){
		// console.log(this.showAdaptiveSubdivision);
		this.drawControlPolygon();
		if(this.VisualizeP){
