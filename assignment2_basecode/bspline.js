...
BSpline.prototype.draw = function(type)
{
...
// ################
	for(var i = 0 ; i < this.nodes.length-3 ; i++){
		var x0 = this.nodes[i].x;
		var x1 = this.nodes[i+1].x;
		var x2 = this.nodes[i+2].x;
		var x3 = this.nodes[i+3].x;

		var y0 = this.nodes[i].y;
		var y1 = this.nodes[i+1].y;
		var y2 = this.nodes[i+2].y;
		var y3 = this.nodes[i+3].y;
